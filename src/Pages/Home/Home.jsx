    ...
    return (
        <div>
            ...
            <div className="bg-[#f7f7f7] pt-8">
                ...
                <div data-aos="fade-up"  data-aos-duration="3000"><Service></Service></div>
                <div data-aos="fade-left" className="mt-20">
                    ...
                    <Gallary></Gallary>
                    <div data-aos="flip-right"  data-aos-duration="3000" className="flex flex-col md:flex-row justify-center gap-8 items-center pb-4">
